SELECT DISTINCT
    ...
    SELECT 
        REPORTING_CODE  
    FROM 
        JAI_ITEM_TEMPL_HDR_V jith, 
        JAI_REPORTING_ASSOCIATIONS_V jra
     WHERE jith.TEMPLATE_HDR_ID = jra.ENTITY_ID  
       AND jith.INVENTORY_ITEM_ID = rsl.ITEM_ID
       AND jith.ORGANIZATION_ID = '94'
       AND jra.REGIME_NAME = 'GST INDIA'
       and jra.REPORTING_TYPE_CODE='GST_HSN_CODE'
    ...
    NVL(jtl.ROUNDED_TAXABLE_AMT_FUN_CURR,0) sval,
    0 disc,
    0 othchrg,
    ...
    mtt.ATTRIBUTE6 vehTyp,
    mtt.ATTRIBUTE7 transDist,
    NULL transName,
    mtt.ATTRIBUTE8 transDocNo,
    REPLACE(mtt.ATTRIBUTE9,'-','/') EWB_transDocDate,
    mtt.ATTRIBUTE9 transDocDate,
