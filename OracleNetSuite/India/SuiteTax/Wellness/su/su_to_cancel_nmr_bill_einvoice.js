...
return Token_Details;		
	...
	{
		var FiltersArray=[  ["type","anyof","VendBill","VendCred"], 
      "AND", 
      ["mainline","is","T"], 
      "AND", 
      ...
      ["memorized","is","F"], 
      "AND", 
      ["custbody_tcp_jv_type","anyof","6","7","10"], "AND",   [["custbody_bulk_einvoice_gen_date","after","twodaysago"],"OR",["custbody_in_ei_ackdt","after","twodaysago"]] ];
	  
	  
	   var ColumnsArray = [
				search.createColumn({name: "transactionnumber",sort: search.Sort.DESC, label: "tranid" }),				 
	...
	["custbody_tcp_jv_type","anyof","6","7","10"], "AND",  [["custbody_bulk_einvoice_gen_date","after","twodaysago"],"OR",["custbody_in_ei_ackdt","after","twodaysago"]]  ];
				 ...
				 var ColumnsArray = [
				search.createColumn({name: "transactionnumber",sort: search.Sort.DESC, label: "Transaction ID" }),				 
				 search.createColumn({name: "internalid", label: "internalid"}),
				 search.createColumn({name: "transactionnumber", label: "doc_num"}),
      ...
      search.createColumn({name: "type", label: "type"}),
        ...
        sublist.setSublistValue({  id: 'custpage_memo', line: lineNum, value: memo });
         ...
         sublist.setSublistValue({  id: 'custpage_amount', line: lineNum, value: Math.abs(amount) });
